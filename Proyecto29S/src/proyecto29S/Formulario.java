...
public class Formulario extends javax.swing.JFrame {
    ...
    public ArrayList<Datos> listaPersonas=new ArrayList<>();
    ...
    private void configurarjTabledatos(){
        modeloTabla = new DefaultTableModel(new String[]{"No Documento", "Apellidos", "Nombres","Facultad","Programa"}, 0);
        jTabledatos.setModel(modeloTabla);
    }
    
    private void agregarPersonas(Datos d){
        modeloTabla.addRow(new Object[]{d.getDoc(),d.getNombres(), d.getApellidos(), d.getFacultad(), d.getPrograma()});
    }
    ...
    if (filaSeleccionada != -1) {
        ...
        int opcion = JOptionPane.showConfirmDialog(this, "¿Eliminar la fila seleccionada?", "Confirmar", JOptionPane.YES_NO_OPTION);
        if (opcion == JOptionPane.YES_OPTION) {
            // Eliminar del modelo de tabla
            modeloTabla.removeRow(filaSeleccionada);
 
            // Eliminar del ArrayList también
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String facultad=(String)jComboBox1.getSelectedItem();
        String programa=(String)jComboBox2.getSelectedItem();
        
        if(!nombres.isEmpty() && !apellidos.isEmpty()){
            try{
            int doc = Integer.parseInt(jTextField1.getText());
            Datos nuevo = new Datos (doc, nombres, apellidos, programa, facultad);
            listaPersonas.add(nuevo);
            agregarPersonas(nuevo);
            }catch(NumberFormatException e){
                javax.swing.JOptionPane.showMessageDialog(this, "El Documento deber ser Numero");
            }
        }else{
